   ...
   const handleSubBody = (index)=>{
    ...
    return (
      <InnerDisplay>
        ...
        <div className='selectBtn'onClick={()=>handleSubBody(1)} ><SubHeader barname={'Society Information' } openStatus={subBody[1]}/></div>
        {subBody[1] && <SocietyInfo/>}
        <div className='selectBtn'onClick={()=>handleSubBody(2)} ><SubHeader barname={'Interest Details for Billing' } openStatus={subBody[2]}/></div>
