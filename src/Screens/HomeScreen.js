...
<div style={{ display: 'flex', overflow:"hidden" }}>
  ...
  <Drawer variant="permanent" open={open}>
    ...
    <div  style={{display:"flex", flexDirection:"row", height:"80px", alignItems:"center", marginLeft:"10px"}} onClick={handleDrawer}>
    ...
    <text style={{marginTop:"10px",pacity: open ? 1 : 0 }} className={Style.menutxt}>
      MENU
    </text>
    ...
    <List>
      {['Dashboard', 'Administrator', 'Society', 'Operations', 'Reports' ,'Utility'].map((text, index) => (
        <ListItem key={text} disablePadding sx={{ display: 'block' }}>
          ...
          >
            ...
            >
              ...
              {index === 0 ? (<MdSpaceDashboard />) : 
              index ===1 ? (<MdManageAccounts   />):
              index ===2 ? (<HiBuildingOffice2   />):
              index ===3 ? (<FaScrewdriverWrench />):
              index ===4 ? (<ImBooks  />):
              index ===5 ? (<FaScrewdriverWrench />):
